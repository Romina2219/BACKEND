...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <input type="text" name="tipo_de_prenda" placeholder="Tipo de Prenda" value="<?php echo "$tipo_prenda"; ?>"> /dentro del value ponemos el dato que que trajimos del registro para que ya aparezca el el imput y no volver aq escribirlo
    <label>Marca</label>
